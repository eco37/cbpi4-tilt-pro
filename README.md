# CraftbeerPi4 Sensor Plugin for Tilt Pro

Allows your Tilt Pro digital hydrometer to send data to CraftBeerPi 4, such as the current temperature and gravity readings. The plugin allows you to create multiple sensors, each of which is associated with a different data type that the device is capturing, so that you can use these sensors as you would any other sensor in CraftBeerPi4. You can also use multiple Tilt Pro devices for different fermentation chambers at the same time. See below for setup instructions.

The plugin is ported from the plugin (https://github.com/PiBrewing/cbpi4-BLEHydrom)
...
- Package Github link: https://github.com/eco37/cbpi4-tilt-pro/archive/refs/heads/main.zip
...
2. Click the **Add** button in the Sensor section, and fill out the sensor properties:
    ...
    2. **Type**: Choose Tilt Pro.
    3. **Tilt Color**: This should be set to the color of your Tilt Pro.
